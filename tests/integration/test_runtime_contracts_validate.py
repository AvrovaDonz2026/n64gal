...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="n64gal_runtime_contracts_") as temp_dir:
        ...
        shutil.copy2(ROOT / "src" / "core" / "runtime_input.c", temp_root / "src" / "core" / "runtime_input.c")
        ...
        shutil.copy2(ROOT / "src" / "core" / "scene_catalog.c", temp_root / "src" / "core" / "scene_catalog.c")
        shutil.copy2(ROOT / "src" / "core" / "runtime_texture.c", temp_root / "src" / "core" / "runtime_texture.c")
