...
VALIDATE_ALL_COMMANDS = (
    ...
    ("validate-release-remote-state", [sys.executable, "tools/validate/validate_release_remote_state.py", "--release-spec", "docs/release-publish-v0.1.0-alpha.json", "--release-json", "tests/fixtures/release_api/github_release_v0.1.0-alpha.json"]),
