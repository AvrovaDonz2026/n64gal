...
if has_changed "include/vn_runtime.h" || has_changed "include/vn_version.h" || has_changed "src/core/runtime_cli.c" || has_changed "src/core/runtime_input.c" || has_changed "src/core/runtime_parse.c" || has_changed "src/core/runtime_persist.c" || has_changed "src/core/runtime_session_support.c" || has_changed "src/core/runtime_session_loop.c" || has_changed "src/core/scene_catalog.c" || has_changed "src/core/runtime_texture.c"; then
