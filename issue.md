...
22. `bfe95d2`：继续同步 perf 文档与跟踪项，明确 `linux-x64` 的 smoke / dirty compare 基线现在统一为 `S1,S3,S10`，而 `qemu-rvv` revision compare 仍暂保留 `S0,S3`；同时 README、平台/性能文档与 dirty-tile API 文档都按这一边界更新。
